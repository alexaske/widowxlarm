...
(cl:defmethod cl:initialize-instance :after ((m <BlockPose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BlockPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name widowx_block_manipulation-msg:<BlockPose> is deprecated: use widowx_block_manipulation-msg:BlockPose instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <BlockPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader widowx_block_manipulation-msg:position-val is deprecated.  Use widowx_block_manipulation-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'orientation-val :lambda-list '(m))
(cl:defmethod orientation-val ((m <BlockPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader widowx_block_manipulation-msg:orientation-val is deprecated.  Use widowx_block_manipulation-msg:orientation instead.")
  (orientation m))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <BlockPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader widowx_block_manipulation-msg:color-val is deprecated.  Use widowx_block_manipulation-msg:color instead.")
  (color m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BlockPose>)))
  ...
  "widowx_block_manipulation/BlockPose")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BlockPose)))
  "Returns string type for a message object of type 'BlockPose"
  "widowx_block_manipulation/BlockPose")
