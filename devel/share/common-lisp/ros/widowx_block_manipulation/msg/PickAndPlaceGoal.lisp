...
(cl:defmethod cl:initialize-instance :after ((m <PickAndPlaceGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PickAndPlaceGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name widowx_block_manipulation-msg:<PickAndPlaceGoal> is deprecated: use widowx_block_manipulation-msg:PickAndPlaceGoal instead.")))
...
(cl:defmethod z_up-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader widowx_block_manipulation-msg:z_up-val is deprecated.  Use widowx_block_manipulation-msg:z_up instead.")
  (z_up m))

(cl:ensure-generic-function 'gripper_open-val :lambda-list '(m))
(cl:defmethod gripper_open-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader widowx_block_manipulation-msg:gripper_open-val is deprecated.  Use widowx_block_manipulation-msg:gripper_open instead.")
  (gripper_open m))

(cl:ensure-generic-function 'gripper_closed-val :lambda-list '(m))
(cl:defmethod gripper_closed-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader widowx_block_manipulation-msg:gripper_closed-val is deprecated.  Use widowx_block_manipulation-msg:gripper_closed instead.")
  (gripper_closed m))

(cl:ensure-generic-function 'pickup_pose-val :lambda-list '(m))
(cl:defmethod pickup_pose-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader widowx_block_manipulation-msg:pickup_pose-val is deprecated.  Use widowx_block_manipulation-msg:pickup_pose instead.")
  (pickup_pose m))

(cl:ensure-generic-function 'place_pose-val :lambda-list '(m))
(cl:defmethod place_pose-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader widowx_block_manipulation-msg:place_pose-val is deprecated.  Use widowx_block_manipulation-msg:place_pose instead.")
  (place_pose m))

(cl:ensure-generic-function 'topic-val :lambda-list '(m))
(cl:defmethod topic-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader widowx_block_manipulation-msg:topic-val is deprecated.  Use widowx_block_manipulation-msg:topic instead.")
  (topic m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PickAndPlaceGoal>)))
  ...
  "widowx_block_manipulation/PickAndPlaceGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PickAndPlaceGoal)))
  "Returns string type for a message object of type 'PickAndPlaceGoal"
  "widowx_block_manipulation/PickAndPlaceGoal")
